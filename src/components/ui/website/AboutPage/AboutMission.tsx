...
const AboutMission = () => {
    return (
        <section className="py-20 bg-[#111111] border-y border-primary/10">
            <Container>
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="bg-[#0A0A0A] p-8 rounded-xl border border-primary/20 text-center hover:border-primary/50 transition-colors">
                            <div className="text-4xl font-serif text-primary mb-2">R5B+</div>
