  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-4xl space-y-4 sm:space-y-6">
        {/* Current Plan */}
        <div className="bg-gradient-to-br from-[#D4AF37]/20 to-[#111111] border border-[#D4AF37]/30 rounded-lg p-4 sm:p-6 lg:p-8">
          <div className="flex flex-col sm:flex-row items-start justify-between mb-6 gap-4">
            ...
            <div className="text-left sm:text-right">
              <div className="text-3xl sm:text-4xl font-serif text-[#D4AF37]">
                R99
              </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-400 pt-4 border-t border-[#D4AF37]/20">
        ...
        {/* Payment Method */}
        <div className="bg-[#111111] border border-[#D4AF37]/20 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-[#1A1A1A] rounded-lg mb-4 gap-3">
            <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
              <div className="w-10 h-8 sm:w-12 sm:h-8 bg-gradient-to-br from-[#D4AF37] to-[#B8941F] rounded flex items-center justify-center flex-shrink-0">
            ...
            <button className="px-4 py-2 text-sm text-[#D4AF37] hover:text-[#E4C77D] transition-colors self-end sm:self-auto">
              Update
            </button>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-6 w-full sm:w-auto">
                  ...
                  <button className="text-[#D4AF37] hover:text-[#E4C77D] transition-colors text-xs sm:text-sm flex items-center gap-1">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#0D0D0D] border border-red-500/30 rounded-xl max-w-md w-full p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={() => setShowCancelModal(false)}
                className="flex-1 px-4 py-2.5 bg-[#D4AF37] text-black font-medium rounded-lg hover:bg-[#E4C77D] transition-colors"
              >
                Keep Subscription
              </button>
              <button
      ...
      {showAddPayment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#0D0D0D] border border-[#D4AF37]/30 rounded-xl max-w-md w-full p-6">
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-xl font-serif text-white">
                Add Payment Method
              </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#1A1A1A] border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-[#D4AF37]"
                />
              </div>
              ...
              <button
                onClick={() => setShowAddPayment(false)}
                className="w-full px-4 py-2.5 bg-[#D4AF37] text-black font-medium rounded-lg hover:bg-[#E4C77D] transition-colors"
              >
                Add Card
              </button>
            </div>
